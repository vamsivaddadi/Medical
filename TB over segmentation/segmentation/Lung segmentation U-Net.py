...
model_checkpoint = ModelCheckpoint('lung_unet_checkpoints.hdf5',
...
model.save('trial_5_lung_segmentation.h5')
...
"""img_num = random.randint(0, image_test.shape[0])
test_image = image_test[img_num]
...
intersection = np.logical_and(mask_test, pred_thresh)
union = np.logical_or(mask_test, pred_thresh)
